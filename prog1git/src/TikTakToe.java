...
private static char[] setSettings(char[] settings){
    ...
    switch (auswahl){
        case 1: System.out.println("Please choose a new token for Player One.");
        settings[0] = scanner.nextLine().charAt(0);
        break;
        case 2: System.out.println("Please choose a new token for Player Two.");
            settings[1] = scanner.nextLine().charAt(0);
            break;
        case 3: System.out.println("Please choose a new color for the playfield:");
    ...
    private static void printPlayfield(int[][] playfield, char[] settings) {
        for (int i = 0; i < playfield.length; i++) {
            for (int cnt = 0; cnt < playfield.length; cnt++) {
                if (cnt == 0) {
                    switch (settings[2]){
                        case 'W': System.out.print(ANSI_WHITE);
                        break;
                        case 'C': System.out.print(ANSI_CYAN);
                            break;
                        case 'M': System.out.print(ANSI_PURPLE);
                            break;
                        case 'B': System.out.print(ANSI_BLUE);
                            break;
                        case 'Y': System.out.print(ANSI_YELLOW);
                            break;
                        case 'G': System.out.print(ANSI_GREEN);
                            break;
                        case 'R': System.out.print(ANSI_RED);
                            break;
                    }
                    System.out.print("| ");
